...
### Código base
Este trabalho de recuperação possui como código-base os códigos da aula de hashes, disponíveis aqui no Github.
...
Cada grupo deverá enviar um único arquivo *.zip* contendo todos os arquivos *.c*, todos os arquivos *.h* e o *makefile* utilizado pelo grupo. O arquivo deverá ser entregado no [Moodle da disciplina](https://campusvirtual.unifal-mg.edu.br/moodle/mod/assign/view.php?id=111982) até as 23h59 do dia 16/12/2025. Entregas em atraso não serão toleradas.
